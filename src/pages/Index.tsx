...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background overflow-x-hidden">
      ...
      <section className="w-full max-w-[1400px] mx-auto px-4 sm:px-6 md:px-8 py-6 sm:py-8 md:py-12 lg:py-20">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 md:gap-8 items-center justify-items-center">
          ...
          <div className="w-full max-w-[150px] sm:max-w-[180px] md:max-w-xs lg:max-w-sm justify-self-end animate-fade-in-right">
            <img
              src="/image9.svg"
              alt="Coriander Mint"
              className="w-full h-auto object-contain transform transition-all duration-700 hover:scale-105 sm:hover:scale-110 md:hover:scale-125 lg:hover:scale-150 hover:rotate-1 sm:hover:rotate-3 md:hover:rotate-6 hover:translate-y-[-5px] sm:hover:translate-y-[-10px] md:hover:translate-y-[-20px] lg:hover:translate-y-[-30px]"
  ...
  "
      ...
      <section className="container mx-auto px-4 md:px-6 lg:px-8 py-12 md:py-16 lg:py-24">
        ...
        <section className="relative bg-gradient-to-br from-white to-gray-50 py-12 md:py-16 lg:py-24 overflow-hidden">
          {/* Decorative background - large chips image */}
          <div className="absolute top-1/2 right-20 sm:right-40 md:right-60 lg:right-80 transform -translate-y-1/2 w-[300px] sm:w-[400px] md:w-[600px] lg:w-[800px] h-[300px] sm:h-[400px] md:h-[600px] lg:h-[800px] -mr-[50px] sm:-mr-[100px] md:-mr-[150px] lg:-mr-[200px]">
            <img
              src="/nacho.png"
              alt=""
          ...
          <div className="container mx-auto px-4 md:px-6 lg:px-8 relative z-10">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-center mb-8 md:mb-12"></h2>

            {/* Product Collage */}
            <div className="relative h-[300px] sm:h-[400px] md:h-[500px] lg:h-[700px] max-w-xs sm:max-w-sm md:max-w-xl lg:max-w-5xl mx-auto">
              {/* Product positions with custom placement */}
              <img
                src="/tandoorimayo.png"
                alt="Mayonnaise Tandoori"
                className="absolute top-[5%] sm:top-[8%] left-[2%] sm:left-[5%] w-[80px] sm:w-[100px] md:w-[140px] lg:w-[180px] transform -rotate-12 hover:scale-110 hover:rotate-0 transition-all duration-500 drop-shadow-2xl"
              />

              <img
                src="/Mayo.png"
                alt="Classic Mayonnaise"
                className="absolute top-[3%] sm:top-[5%] left-[20%] sm:left-[25%] w-[90px] sm:w-[120px] md:w-[160px] lg:w-[200px] transform rotate-8 hover:scale-110 hover:rotate-0 transition-all duration-500 drop-shadow-2xl"
              />

              <img
                src="/mayosachet.png"
                alt="Mayonnaise Pouch"
                className="absolute top-[8%] sm:top-[10%] right-[3%] sm:right-[5%] w-[90px] sm:w-[120px] md:w-[150px] lg:w-[190px] transform -rotate-6 hover:scale-110 hover:rotate-0 transition-all duration-500 drop-shadow-2xl"
              />

              <img
                src="/image 9.png"
                alt="Spread Packet"
                className="absolute bottom-[15%] sm:bottom-[20%] left-[5%] sm:left-[8%] w-[90px] sm:w-[110px] md:w-[140px] lg:w-[180px] transform rotate-15 hover:scale-110 hover:rotate-0 transition-all duration-500 drop-shadow-2xl"
              />

              <img
                src="/image 29.png"
                alt="Pizza & Pasta Sauce"
                className="absolute bottom-[10%] sm:bottom-[12%] right-[10%] sm:right-[15%] w-[120px] sm:w-[150px] md:w-[180px] lg:w-[230px] transform -rotate-10 hover:scale-110 hover:rotate-0 transition-all duration-500 drop-shadow-2xl"
              />
            </div>
          </div>
        </section>
        <div className="relative">
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6 lg:gap-8"></div>
          {/* Decorative yellow shape */}
          <div className="absolute top-1/2 right-0 w-24 h-24 sm:w-32 sm:h-32 md:w-48 md:h-48 lg:w-96 lg:h-96 bg-accent -mr-6 sm:-mr-10 md:-mr-16 lg:-mr-20 -mt-12 sm:-mt-16 md:-mt-24 lg:-mt-32 opacity-30 -z-10 transform rotate-12"></div>
        </div>
      </section>
      ...
      <section className="bg-black text-white py-12 md:py-16 lg:py-20 relative overflow-hidden">
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row items-start justify-between">
            ...
            {/* Right side - Cards */}
            <div className="lg:w-1/2 flex flex-col sm:flex-row justify-between gap-6 md:gap-8">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-6 md:gap-8 lg:gap-16">
          ...
          <div className="lg:w-1/2 space-y-8 md:space-y-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
              ...
              <div className="bg-white rounded-2xl sm:rounded-3xl p-4 sm:p-6 shadow-lg">
                <div className="text-center mb-3 sm:mb-4">
                  <h3 className="text-lg sm:text-xl font-bold mt-3 sm:mt-4 mb-2 sm:mb-3">Always Fresh</h3>
                  <p className="text-gray-600 text-xs sm:text-sm">
